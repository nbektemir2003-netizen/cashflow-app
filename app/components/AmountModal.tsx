...
export default function AmountModal({ categoryName, categoryIcon, type, accounts, onConfirm, onClose }: Props) {
  ...
  const handleConfirm = () => {
    ...
    onConfirm(amount, note.trim() || undefined, accountId || undefined)
  }
