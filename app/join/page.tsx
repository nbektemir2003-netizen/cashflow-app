  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-center text-lg max-w-sm mb-12 leading-relaxed">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-sm w-full mb-12">
          {[
            ...
            <div key={f.title} className="bg-gray-200 dark:bg-gray-800 rounded-2xl p-4 border border-gray-300 dark:border-gray-700/50">
              <div className="text-2xl mb-2">{f.icon}</div>
              <div className="text-gray-900 dark:text-white font-semibold text-sm mb-0.5">{f.title}</div>
        ...
        {!done ? (
          <div className="w-full max-w-sm">
            <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl p-6 border border-gray-300 dark:border-gray-700/50">
              <h2 className="text-gray-900 dark:text-white font-bold text-lg mb-1 text-center">Получить доступ</h2>
          ...
          <div className="w-full max-w-sm">
            <div className="bg-green-900/20 border border-green-700/40 rounded-2xl p-8 text-center">
              ...
              <h2 className="text-gray-900 dark:text-white font-bold text-xl mb-2">Заявка принята!</h2>
      ...
      <footer className="text-center py-6 text-gray-300 dark:text-gray-700 text-xs">
        © 2026 Финик
      </footer>
    </div>
  )
